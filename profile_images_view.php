...
$stmt_f->bind_param("ss", $user_id_f, $image_word);
$stmt_f->execute();
$stmt_f -> store_result(); 
...
<div class="col-xl-3 col-lg-4 col-6">
    <div class="portfolio-image">
        <a href="users/<?= $user_id_f ?>/<?= $file ?>" class="glightbox" data-gallery="gallery">
            <img src="users/<?= $user_id_f ?>/<?= $file ?>" alt="" class="img-fluid blur-up lazyload bg-img" style='object-fit:cover; height:250px; width:100%;'>
        </a>
    </div>
</div> 
<?php } } ?>
