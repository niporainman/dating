...
if(isset($_POST['button'])) {
    ...
    $stmt = $con->prepare("SELECT id FROM admin WHERE username=? AND password=? LIMIT 1");
    ...
    <nav>
        <div class="app-logo">
            <a class="logo d-inline-block" href="index.php">
                <img alt="#" src="assets/images/logo/1.png" style='border-radius:5px;'>
            </a>
        ...
        <div class="app-nav" id="app-simple-bar">
            <ul class="main-nav p-0 mt-2">
                ...
                <li class="no-sub">
                    <a class="side_icon" href="index.php">
