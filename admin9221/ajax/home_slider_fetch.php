            ...
            <div class="col-md-6 col-lg-4 col-xxl-3">
                ...
                <div class="card blog-card overflow-hidden">
                    <a class="glightbox img-hover-zoom" data-glightbox="type: image; zoomable: true;"
                        href="../site_img/home_background/<?= $picture ?>">
                        <img alt="..." class="card-img-top" src="../site_img/home_background/<?= $picture ?>">
                    </a>
                        ...
                        <div class="modal-body">
                            <form id="form<?= $id ?>" class="app-form ajax-form" enctype="multipart/form-data">
                                ...
                                <div class="form-floating mb-3">
                                    <input class="form-control" id="floatingInput1" placeholder="Heading" name='heading' type="text" value="<?= $heading ?>" required>
                                    <label for="floatingInput1">Heading</label> 
                                </div>
                                <div class="form-floating mb-3">
                                    <textarea name='paragraph' class="form-control" placeholder="Paragraph" required><?= $paragraph ?></textarea>
