                        ...
                        <div class="modal-body">
                            <form id="form<?= $id ?>" class="app-form ajax-form" enctype="multipart/form-data">
                                ...
                                <div class="form-floating mb-3">
                                    <input class="form-control" id="floatingInput1" placeholder="Category Name" name='category_name' type="text" value="<?= $category_name ?>" required>
