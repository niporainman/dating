...
$page_name = "team.php";
	...
	$stmt -> execute(); 
	$stmt -> store_result(); 
	$stmt -> bind_result($id,$name,$position,$picture); 
            ...
            <div class="col-md-6 col-lg-4 col-xxl-3">
                ...
                <div class="card blog-card overflow-hidden">
                    <a class="glightbox img-hover-zoom" data-glightbox="type: image; zoomable: true;"
                        href="../site_img/team/<?= $picture ?>">
                        <img alt="..." class="card-img-top" src="../site_img/team/<?= $picture ?>">
                    </a>
                        ...
                        <div class="modal-body">
                            <form id="form<?= $id ?>" class="app-form ajax-form" enctype="multipart/form-data">
                                ...
                                <div class="form-floating mb-3">
                                    <input class="form-control" id="floatingInput1" placeholder="Name" name='name' type="text" value="<?= $name ?>" required>
                                    <label for="floatingInput1">Heading</label> 
                                </div>
                                <div class="form-floating mb-3">
                                    <textarea name='position' class="form-control" placeholder="Position" required><?= $position ?></textarea>
                                    <label>Position</label>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">File</label> <br>
                                    <img src="../site_img/team/<?= $picture ?>" alt="team member" class="img-fluid mb-2">
